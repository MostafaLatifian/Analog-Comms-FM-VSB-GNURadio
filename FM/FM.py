...
class FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(0, 10000, 1, 5000, 200)
        ...
        self.qtgui_time_sink_x_3.set_y_label('Amplitude(dB)', "")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(500000, analog.GR_COS_WAVE, fc, 10, 0, 0)
        ...
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.blocks_nlog10_ff_3, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.qtgui_time_sink_x_3, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_5, 0), (self.qtgui_time_sink_x_4, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.blocks_nlog10_ff_0, 0), (self.blocks_multiply_const_vxx_2, 0))
        ...
        self.connect((self.blocks_nlog10_ff_3, 0), (self.blocks_multiply_const_vxx_5, 0))
