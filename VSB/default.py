...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Beta_range = qtgui.Range(0.1, 5, 0.1, 1, 200)
        ...
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_ff(Beta, 1)
        ...
        self.band_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 40000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 5000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 40000, 100, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_mag_squared_0_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_nlog10_ff_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.blocks_rms_xx_0_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.blocks_rms_xx_0_0_0, 0), (self.blocks_float_to_complex_0_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.band_pass_filter_0, 0))
        self.connect((self.blocks_vector_to_stream_0, 0), (self.blocks_complex_to_mag_squared_0_1, 0))
        self.connect((self.fft_vxx_0, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_multiply_const_xx_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_rms_xx_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 35000, 38000, 1, window.WIN_HAMMING, 6.76))
    ...
    def set_Beta(self, Beta):
        self.Beta = Beta
        self.blocks_multiply_const_xx_0.set_k(self.Beta)
